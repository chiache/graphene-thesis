...
%\papersubsection{\usagemetric{} of Linux System Calls}
\papersection{Linux system calls}
...
The study also shows the contributors
...
%\papersubsection{From ``Hello World'' to Qemu}
...
\papersection{Vectored system call opcodes}
...
\papersection{Pseudo files and devices}
