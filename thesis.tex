...
\newcommand{\fixmedp}[1]{{}}
\else
\usepackage[textsize=footnotesize,textwidth=1.3in,shadow]{todonotes}
\WarningFilter{latex}{Marginpar on page}
\newcommand{\placeholder}[0]{\todo[inline,size=\normalsize,color=green!40]{\bf To be written.}}
\newcommand{\fixme}[2][]{{\todo[caption=, #1, fancyline]{
...
\newcommand{\fixmedp}[1]{\fixme[color=red!40]{[dP]: #1}}
\fi
