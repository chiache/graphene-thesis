...
\newcommand{\fixmedp}[1]{{}}
\else
\usepackage[textsize=footnotesize,textwidth=1.3in,shadow,colorinlistoftodos]{todonotes}
\WarningFilter{latex}{Marginpar on page}
\newcommand{\placeholder}[0]{\todo[caption=\thechapterorsection, inline, size=\normalsize, color=yellow!40, list]{\bf To be written.}}
...
\titlespacing{\subsubsection}{0pt}{3.5ex plus .1ex minus .2ex}{.5ex minus .05ex}
\titlespacing{\paragraph}{0pt}{3.5ex plus .1ex  minus .2ex}{1pc}

\titleformat{\section}{\normalfont\fontsize{14}{28}\bfseries}{\thesection}{1em}{}
