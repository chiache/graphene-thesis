...
\newcommand{\thesistitle}{Building Linux Compatibility Layers with A Library Operating System}
...
\usepackage[textsize=footnotesize,textwidth=1.2in]{todonotes}
...
\newcommand{\fixmedp}[1]{\fixme[color=red!40]{#1}}
\fi
