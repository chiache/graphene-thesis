...
\declarecommand{\paperchapter}[1]{\chapter{\titlecap{#1}}}
\declarecommand{\papersection}[1]{\section{\titlecap{#1}}}
\declarecommand{\papersubsection}[1]{\subsection{\titlecap{#1}}}
\declarecommand{\papersubsubsection}[1]{\subsubsection{\titlecap{#1}}}
