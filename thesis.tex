...
\Addlcwords{and a an the with in of on upon for to}

\titleformat{\section}[block]{}{\normalfont\Large\bfseries\thesection}{1em}{\formatsectiontitle}
\newcommand{\formatsectiontitle}[1]{\normalfont\Large\bfseries\titlecap{#1}}

\titleformat{\subsection}[block]{}{\normalfont\large\bfseries\thesubsection}{1em}{\formatsubsectiontitle}
\newcommand{\formatsubsectiontitle}[1]{\normalfont\large\bfseries\titlecap{#1}}

\titleformat{\subsubsection}[block]{}{\normalfont\normalsize\bfseries\thesubsubsection}{1em}{\formatsubsubsectiontitle}
\newcommand{\formatsubsubsectiontitle}[1]{\normalfont\normalsize\bfseries\titlecap{#1}}

\titleformat{\paragraph}[runin]{}{}{\charwidth}{\formatparagraphtitle}
\newcommand{\formatparagraphtitle}[1]{\normalfont\normalsize\bfseries\titlecap{#1}}
