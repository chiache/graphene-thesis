...
the same features and behaviors in a system interface,
as application developers learn when an application is produced.
The quality of an OS to maintain a system interface
that matches with the development background of applications
