...
A system interface may contain outdated specifications of features and application programming interface (API).
Because of compatibility, OS developers generally avoid modifying the system interface,
despite the missed opportunities for
making more significant improvements by changing both OS and application sides.
...
These are examples that compatibility %of a system interface
