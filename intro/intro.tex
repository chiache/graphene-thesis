...
A system interface can isolate an application from the idiosyncrasy of hardware interfaces, and make the application  portable across hardware platforms.
To application developers,
a system interface reveals the OS as an extended machine~\cite{dhamdhere2007os-textbook},
with a consistent view of all the OS and hardware features
...
have defined their own system interfaces,
for facilitating application programming.
