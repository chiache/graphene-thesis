...
For OS and hardware developers, achieving or preserving compatibility is often a distraction to innovations, even though compatibility is critical to system usability.
...
This thesis describes an OS design and general principles for reducing the development effort devoted to improving compatibility.
...
Established upon the former work, \graphene{} holds the following key contributions:
