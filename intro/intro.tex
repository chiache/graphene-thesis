...
In many OSes, system interfaces are defined to be portable on physical machines
...
and many POSIX-compliant OSes~\cite{ieee-posix}
share such a merit of enhanced reusability, portability, and distribution
in application code,
thanks to the way their system interfaces are defined.
...
The importance of system interfaces forces OS developers to focus on keeping the system interfaces compatible against applications,
