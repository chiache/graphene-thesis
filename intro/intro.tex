...
Usage of a system interface is mostly hard-coded
in a fully-compiled application.
...
\polishthis{OS developers avoid modifying the system interface,
despite any missed opportunities to
making more significant improvements by fine-tuning both OS and application sides.}
