...
The \fixmedp{from the programmers' perspective} top-down view of an OS is an extended machine or a ``virtual machine''~\cite{tanenbaum19os-textbook,dhamdhere2007os-textbook},
...
One characteristic of a UNIX-style program is the opportunity of utilizing multiple processes, and cloning more processes using \syscall{fork}.
