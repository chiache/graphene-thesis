...
The \drawbridge{} design is later adopted by Bascule~\cite{baumann13bascule} and Haven~\cite{baumann14haven}, to show the feasibility of implementing single-process, Linux functionality, and porting to Intel SGX, respectively.
Established upon the former work, the key contribution of \graphene{} is 
...
Besides the library OS, this thesis also studies the general principles
