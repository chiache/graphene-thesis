...
Application portability is a key quality to many OSes, but has gradually
...
After all, application developers need to trust an OS to reproduce consistent functionality for an application,
