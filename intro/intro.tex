...
The importance of system interfaces forces OS developers to keep the system interface of an OS compatible against applications,
...
New hardware designs are leaking out of the encapsulation of system interface,
and thus compromising compatibility.
...
The extra effort on compatibility can delay the deployment of innovative hardware designs, or disrupt application usability on new physical machines.
