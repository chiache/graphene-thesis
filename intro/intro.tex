...
\subsection{Running unmodified applications on SGX}
\label{sec:intro:sgx}
...
certain instructions such as \code{cpuid} and \code{rdtsc} from an application.
...
to applications.
Also, SGX forbids \code{cpuid} and \code{rdtsc} because these instructions are easily intercepted or spoofed by an OS
or a hypervisor.
...
Especially, \syscall{fork} is an unique feature of UNIX-style OSes, such as Linux and BSD,
