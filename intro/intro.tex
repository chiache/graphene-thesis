...
This thesis defines the quality of an OS to reproduce a system interface
that matches with the hard-coded requests from applications, as {\bf compatibility}.
