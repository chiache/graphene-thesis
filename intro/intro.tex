...
in the binaries.
\polish{Application developers make decisions of embedding the interaction with a system interface inside of an application.}
...
Other examples can be found among research-type, asymmetric multi-processing architectures,
especially ones without inter-connected, coherent memory~\cite{gschwind2007,cascaval2002evaluation}, which complicates the implementation of state-sharing, multi-process abstractions. 
