...
In many OSes, system interfaces are defined to be portable across physical machines
with various hardware configurations,
including different CPU models, memory sizes, and I/O devices,
to make applications more distributable.
...
share the merit of making the hardware usage in an application both comprehensive and adaptable,
thanks to the encapsulation of system interfaces.
...
The importance of system interfaces on application forces OS developers to retain the system interfaces compatible for applications,
despite of challenges in developing OS support for new hardware abstractions.
...
to the limited amount of applications, CPUs, RAMs, and I/O devices available at the time~\cite{ritchie78unix-retro}.
...
on new hardware designs which leak out of the abstractions encapsulated by the system interface.
...
The additional effort for retaining the compatibility can delay the deployment of a new hardware technology, or disrupt an application on new machines.
...
A running example used in this thesis %of a disruptive hardware design
