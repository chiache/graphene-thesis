...
idiosyncratic hardware interfaces, as designed by the manufacturers.
Although it is possible to program an application against bare hardware,
the application will fail to execute upon other hardware with unmatched hardware interfaces.
An OS allows application developers to program against
...
or restricting users to run the application on specific hardware.
...
\polish{The development of a fully-compiled application (not as a script or intermediate instructions)
normally involves hard-coding the usage of a system interface.
Application developers make the decisions of embedding the intention and parameters
of calling a system interface, inside an application.}
