...
An system interface may contain outdated specifications of OS features and application programming interface (API);
...
As an indisputable reason for maintaining compatibility,
it is possible that application developers are unwilling to modify an application,
either in the source code or in binaries.
The development of a commercial application
requires a thorough process of testing and code inspection to ensure the correctness and safety of the application.
Application developers may consider modifying or recompiling an application %for a new hardware or system interface to be 
a risk for application stability.
...
All these dilemmas call for a solution
to translate an alternative system interface for unmodified application binaries.
...
\rewrite{The key to compatibility
...
to address the emerging compatibility challenges in OS development and innovation.}
