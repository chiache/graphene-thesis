...
a part of an OS, or more specifically, the API components (e.g., system call table), to user space.
...
This thesis tries to strike a better balance % the trade-offs
between simplicity of the host interface
and sufficiency of the library OS functionality. % to be compatible against applications.
According to
...
\polish{Established upon the previous work,
\graphene{} %extends the concept of previous work
presents an overall solution for running unmodified applications upon a variety of host OSes and hardware,
and defines a host interface that is simple to port and sufficient to support a full-feature \libos{}.}



%\issue{1.3.a}{Compare Graphene vs Docker}
%Established upon the previous work, 
\rewrite{This thesis has several contributions over previous work.}
