...
Because an OS is constantly under extension to support new hardware,
...
when the new hardware leak out of the abstractions encapsulated by the system interface.
If OS developers have to extend a system interface
to facilitate the programming of a new hardware, 
the OS loses the compatibility against existing applications 
to utilize this hardware.
%the extension will be difficult to benefit existing applications.
