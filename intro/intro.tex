...
\begin{outline}
Motivation:
-- Linux is widespread among server/desktop/embedded systems
-- Many applications are dependent to Linux
-- Linux exports complex kernel interfaces, which are indispensable to Linux applications
-- Complex kernel interfaces hinder researchers to explore new kernel designs
-- Complex kernel interfaces are prone to vulnerability
Thesis:
...
Linux operating systems are widespread among server, desktop, and embedded systems.
