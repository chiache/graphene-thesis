...
is to encapsulate the low-level hardware resources and abstractions~\cite{ritchie74unix}, in programmable system interfaces.
...
with a consistent system interface
which hides the idiosyncrasy of physical hardware interfaces.
...
Most system interfaces are defined to be portable to physical machines
with different hardware configurations,
such as CPU models, memory sizes, and I/O devices,
and thus makes applications also portable.
...
Although most OSes still restrict applications to be compiled with a choice of ISA (instruction set architecture), such as x86 or powerpc,
the programming of system interfaces is mostly independent
from the choice of hardware devices.
...
and any POSIX-compliant OSes~\cite{ieee-posix},
share the merit of improving the reusability, portability, and distribution
of application code,
due to the definition of system interfaces.
...
Due to the relevance of system interfaces to application programming, the development of an OS is often bound by
system interface definitions,
for the compatibility against existing applications.
...
for applications, CPUs, RAMs, and I/O devices available at the time~\cite{ritchie78unix-retro}.
%The problems lies in the complexity of
However, %due to rapid growth of applications and hardware products,
OS developers are increasingly burdened by compatibility,
...
including changing the trusted nature of OS services (more discussed in Section~\ref{sec:intro:sgx}).
