...
According to
a study of the Linux system API~\cite{tsai16apistudy},
not all Linux \linuxapi{} are equally important to reusability of applications upon a host OS.
Also, not all applications 
are equally important to be reused upon different host OSes and hardware.
...
and it is less valuable to reuse these programs than just using the tools available in the host.
