...
of the less secure \syscall{open} and others, but struggle to completely replace the latter due to compatibility.
...
codenamed ``Longhorn'',
which planned to introduce a brand-new user interface API
and database-like file system~\cite{spolsky04microsoft-api-war}.
...
These are examples that maintaining the complete compatibility of a system interface
