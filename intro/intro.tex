...
a idiosyncratic system interface and hardware prerequisites.
...
with a lot of Linux-specific flags, sub-interfaces, and corner cases invented along the way~\cite{linux-man-syscall}.
Developing a fully-compatible OS, for any existing Linux applications, %, to reuse any application,
requires faithfully reproducing
the idiosyncratic features of the Linux \linuxapis{},
...
regardless of hardware-specific restrictions.
