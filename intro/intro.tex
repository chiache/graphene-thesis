...
to bridge the gap of system interface definitions, including both the API and the nature of OS features.
...
To build a more adaptable alternative than a VM, OS developers can partition an OS, to virtualize only necessary OS components into a compatibility layer---a {\bf \libos{}}~\cite{porter11drawbridge,engler95exokernel,libra,unikernels}
loaded inside applications.
...
This thesis presents {\bf \graphene{}}, a library OS for running unmodified Linux applications on various host OSes and hardware.
