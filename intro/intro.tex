...
If a milestone in OS development requires redefining part of the system interface,
...
will define
the quality of reproducing a system interface that matches with the hard-coded OS requests in applications,
as {\bf compatibility}.
...
In general, OS developers recognize loss of compatibility as a problem with direct consequences
on user experiences.
