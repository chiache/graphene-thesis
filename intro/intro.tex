...
A system interface can contain an early specification of OS functionality and application programming interface (API).
...
Generally, deprecating a \linuxapi{} is a length process, wherein application developers must be repeatedly warned
until the process finally expires.
Moreover, a large-scale redefinition of the system interface
may disrupt compatibility even further.
