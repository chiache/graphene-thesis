...
the application will fail to execute upon other hardware with different hardware interfaces.
\keepthis{An OS allows application developers to program against
