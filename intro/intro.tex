...
Generally, deprecating a \linuxapi{} is a length process, wherein application developers are repeatedly warned.
...
These examples show that prioritizing compatibility %of a system interface
