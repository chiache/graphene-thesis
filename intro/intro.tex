...
which presents a consistent view of hardware and OS features
for programming.
...
A portable application can be reused
upon different hardware options encapsulated by the OS, such as CPU models, memories, and I/O devices.
...
have all defined a versatile system interface
to facilitate the programming of a portable application.
...
A prerequisite to the long-term portability of an application
is to have a compatible system interface.
{\bf Compatibility} represents
\fixme{Check this: defining compatibility}
the ability of an OS to reproduce the features of a system interface, for reusing an application previously developed with these features.
