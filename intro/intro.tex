...
A UNIX-style OS
encapsulates hardware resources and abstractions~\cite{ritchie74unix}, using a programmable system interface.
...
A system interface is often portable across hardware configurations, including CPU models, memory sizes, and I/O devices, to broadly reuse applications.
...
to make an application more adaptable and distributable.
...
As hardware development will continues after application releases,
...
The extra effort on compatibility can delay the deployment of an innovative hardware product, or obstruct reusing an application on new physical machines.
