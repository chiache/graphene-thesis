...
SGX also excludes OS services from the trust model, except functions which can be completely ported to user space (e.g. \syscall{malloc}).
The absence of trusted OS services is an issue for porting an existing application.
...
Since \graphene{} does not assume a coherent kernel space, it can become a flexible option
