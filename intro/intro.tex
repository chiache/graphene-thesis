...
This thesis targets the compatibility against commercially-used, popular Linux applications, including server-type applications, command-line programs, and language runtimes.
...
Last but not least, comparable to a virtual machine, \graphene{} enforces security isolation
