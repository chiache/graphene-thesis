...
%the OS development can be transparent to applications, the adoption of a new hardware will lag behind the invention, due to lack of compatible OS support with existing applications.
