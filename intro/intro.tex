...
especially ones without inter-connected, coherent memory~\cite{gschwind2007,cascaval2002evaluation}. 
...
A challenging task in OS development
is to prevent compatibility to become a distraction to hardware innovation.
...
contains a lot of OS-specific abstractions and behaviors.
...
many of which are unique to Linux.
...
regardless of any hardware restrictions.
