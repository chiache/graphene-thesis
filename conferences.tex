...
\conferencename{\podc}{PODC}{Proceedings of the ACM symposium on Principles of distributed computing (PODC)}
...
\conferencename{\usenixsum}{USENIX Summer}{{Proceedings of the USENIX Summer Technical Conference}}
...
\conferencename{\hotnets}{HotNets}{{Proceedings of the 14th ACM Workshop on Hot Topics in Networks (HotNets)}}
...
\conferencename{\cluster}{{IEEE Cluster}}{{IEEE International Conference on Cluster Computing (IEEE Cluster)}}

\conferencename{\apsys}{{APSys}}{{Asia-Pacific Workshop on Systems}}
\conferencename{\msst}{{MSST}}{IEEE Conference on Mass Storage Systems and Technologies (MSST)}
\conferencename{\systor}{{SYSTOR}}{ACM International Systems and Storage Conference (SYSTOR)}
\conferencename{\sacmat}{{SACMAT}}{ACM Symposium on Access Control Models and Technologies (SACMAT)}
\conferencename{\sdnnvfsecurity}{{SDN-NFV Security}}{{Proceedings of the ACM International Workshop on Security in Software Defined Networks \& Network Function Virtualization (SDN-NFV Security)}}

\conferencename{\acsac}{{ACSAC}}{{Proceedings of the Annual Computer Security Applications Conference (ACSAC)}}

\conferencename{\ndsi}{{NDSI}}{{Proceedings of the USENIX Symposium on Networked Systems Design and Implementation (NDSI)}}

\conferencename{\csfw}{{CSFW}}{{In IEEE Computer Security Foundations Workshop (CSFW)}}

\conferencename{\ipdps}{{IPDPS}}{{Proceedings of IEEE International Parallel and Distributed Processing Symposium (IPDPS)}}

\conferencename{\asiaccs}{{ASIACCS}}{{Proceedings of the ACM Symposium on Information, Computer and Communications Security (ASIACCS)}}

\conferencename{\hasp}{{HASP}}{{Proceedings of the Fourth Workshop on Hardware and Architectural Support for Security and Privacy}}
