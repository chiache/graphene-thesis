...
\begin{figure}[t!]
\centering
\includegraphics[width=26em]{architecture.pdf}
...
Finally, only two enclave calls, namely \funcname{FILE\_ATTRS} and \funcname{DIR\_LIST}, are {\em unsafe}, because \graphenesgx{} currently do not protect
