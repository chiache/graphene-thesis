\section{Shielding Linux Abstractions}
\label{sec:overview}
...
\subsection{Shielding Single-Process Abstractions}
\label{sec:overview:basics}
...
Table~\ref{tab:interface} lists our \enclavecallnum{} enclave interfaces,
organized by risk.
