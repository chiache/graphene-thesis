...
Various cryptographic function implementations
...
For instance, developers should avoid using table-based AES implementations,
and switch to more secure AES implementation
or the hardware-accelerated AES-NI~\cite{hofemeier2012aesni}.
...
The same intention
applies to \graphenesgx{}, despite the significant difference of the threat models.


In \graphenesgx{}, the manifest is extended to protect an application from the untrusted host file system.
...
\subsection{Inter-enclave coordination}
