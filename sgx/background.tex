...
which recycles a significant portion of the \win{} 7 source code.
...
A key question for developing a \sgx{} framework is how much OS functionality should be pull into an enclave.
