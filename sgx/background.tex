...
as a hardware support for trusted execution environments (TEEs)
...
The primary abstraction of the SGX platform is an {\bf enclave}, an isolated execution environment within the virtual address space of a process.
...
package unencrypted or unauthenticated; when memory contents are read back into cache,
