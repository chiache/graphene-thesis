...
Besides running unmodified Linux binaries on \sgx{}, \graphenesgx{} also contributes several usability enhancements,
...
corrupting a protected stack by returning an address on the stack from \syscall{mmap};
