...
\palcall{ThreadYield} simply yields the CPU, and the caller thread can be rescheduled immediately by the host scheduler.
...
The host ABI includes two scheduling primitives: one is mutex locking, and the other is 
