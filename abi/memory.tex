...
\syscall{VirtMemAlloc} is similar to \syscall{mmap}, except it only creates anonymous mappings;
also, \syscall{VirtMemProtect} and \syscall{VirtMemFree}
are mostly equivalent to
\syscall{mprotect} and \syscall{munmap}, respectively.
...
\syscall{VirtMemAlloc}, \syscall{VirtMemProtect}, and \syscall{VirtMemFree}
