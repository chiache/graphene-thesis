...
regulates that the arguments to a function are passed in certain general-purpose registers---specifically stored in \code{rdi}, \code{rsi}, \code{rdx}, \code{rcx}, \code{r8}, and \code{r9}, in order~\cite{system-v-abi}.
