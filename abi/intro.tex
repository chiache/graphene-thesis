...
\fixmedp{I think you can make this sentence more direct: "The library OS is loaded by the host OS as user libraries."}
...
\fixmedp{I might make this point clearer: on all systems, the PAL includes a simple ELF loader (even Linux).  For Windows or OS X, the PAL is not itself ELF, but rather a native binary, that includes an ELF loader.
}
