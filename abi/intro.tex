...
regulates the arguments of a function to be passed in certain general-purpose registers---specifically stored in \code{rdi}, \code{rsi}, \code{rdx}, \code{rcx}, \code{r8}, and \code{r9}~\cite{system-v-abi}.
