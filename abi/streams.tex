...
According to consecutive operations, handles returned by \palcall{StreamOpen}
...
\palcall{StreamAttrSetByHandle} is a \hostapi{} for changing
...
A dilemma for defining this \palkeyword{STREAM_ATTRS} data structure is
to determine which stream attributes
should be exposed to the guest.
especially the attributes for a network stream (i.e., flags included in \palkeyword{network_option}), ,
