...
both \syscall{StreamMap} and \syscall{mmap} maps regular files into the application memory. %, for reading or writing data.
...
including \code{access\_flags}, \code{share\_flags}, \code{create\_flags}, and \code{options},
