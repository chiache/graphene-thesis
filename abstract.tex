...
%%The study reveals that all system APIs are not equally important for emulating, and by prioritizing API emulation developers can plan a optimal path to support a wide range of applications.
