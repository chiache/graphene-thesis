...
%In particular, for a platform as unique as a \libos{},
%reusing the applications from commodity operating systems (e.g., Windows and Linux)
%In particular,
%reusing the applications from commodity operation systems
%(e.g., Windows and Linux)
%on a vastly different platform, like the \liboses{},
...
--- at a lower cost~\cite{porter11drawbridge}.
...
as the so-called \emph{\picoprocs{}}.
...
We design a library OS called \emph{\graphene{}}~\cite{tsai14graphene},
...
Besides reusing whole applications on diverse platforms,
the \libos{} also
allows securing a sensitive part of an applications written in managed languages (e.g., \java{}), in an isolated enclave.
Using \graphene{}, we build a prototype framework called \emph{\civet{}}, which
