...
%\papersection{Addressing the Combination of \java{} and \sgx{}}
\papersection{\java{} Support for Partitioning into \sgx{}}
\label{sec:concept}
...
\papersubsection{Cleanly partitioning classes and objects}
...
\papersubsection{Dynamically loading byte-code with integrity}
...
\papersubsection{Seamless access to in-enclave objects}
...
\papersubsection{Remote Attestation and Provisioning}
...
\papersection{Filtering Information Flow at Enclave Border}
\label{sec:security}
...
%\papersubsection{Benefits from the usage of \java{} Language}
...
\begin{comment}
\papersubsection{Reducing the enclave TCB}
...
%\papersubsection{Information Flow Control at Enclave Boundary}
