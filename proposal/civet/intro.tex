...
Iago attacks~\citep{iago}, where an OS offers malicious system call return values,
...
\systemname{} uses the Graphene library OS~\citep{tsai14graphene} to facilitate 
