...
\caption[An overview of the \sysname{} design-time tool.]
...
\begin{figure}[t!]
\centering
\includegraphics[width=3.5in]{civet/figures/declassify.pdf}
\footnotesize
\caption[How \sysname{} provides declassifier APIs to declassify sensitive data.]
