...
(\term{\graphenesgx{}})
can isolates applications, either single-process or multi-process,
on a host where neither the operating system or the hardware (except the CPU package)
is not trusted by the applications. 
