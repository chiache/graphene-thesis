...
\hline
\end{tabular}
\caption[\sysname{}: multi-process abstractions implemented.]
...
the {\tt SIGUSR1} handler will be called upon return. Also in Figure~\ref{fig:coordination}, \picoproc{} 4 (PID 2) waits on 
