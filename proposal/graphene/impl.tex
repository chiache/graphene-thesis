\section{Implementation Details in \sysname{}}
...
by porting \pal{} to \term{FreeBSD}, \term{OSX} and \term{Windows}.
...
{Lines of code written or changed to produce \sysname{}.  Applications and other libraries are unchanged. \fixme{update numbers}}
