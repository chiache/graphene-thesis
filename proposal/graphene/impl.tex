...
\vspace{5pt}
\noindent{\bf Alternative host \pal{} ports.~}
As a proof-of-concept of the platform independence of \sysname{},
...
\hline
\end{tabular}
\caption[Lines of code written or changed to produce \sysname{}]
...
\vspace{5pt}
\noindent{\bf Implementing Linux Personality.~} 
...
\vspace{5pt}
\noindent{\bf Synchronization.~} Perhaps surprisingly, implementing Linux
