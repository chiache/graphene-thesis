...
%which exposes only tens of simple host calls. \daniela{briefly define picoprocess: A picoprocess is unmodified application code running with a libOS.}
...
\tsai{Figure updated.}
\fix{
Building block of Graphene architecture.  Black components are unmodified.
...
\end{tabular}
\caption{Classes of 
host ABI functions adopted from Drawbridge~\citep{porter11drawbridge}, 
...
%across mutually untrusting picoprocesses,
...
\vspace{5pt}
\noindent {\bf PAL ABI Changes.~} When implementing Graphene,
...
\vspace{5pt}
\noindent{\bf Comparison with microkernels.~}
