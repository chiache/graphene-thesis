...
\begin{figure}[t!]
\centering
\includegraphics[width=5.5in]{graphene/figures/arch.pdf}
\caption[\sysname{}: the building blocks.]
...
\hline
\end{tabular}
\caption[\sysname{}: list of host ABI functions.]
...
\vspace{5pt}
\noindent{\bf Multi-Process Support in \sysname{}.~}
...
\vspace{5pt}
\noindent {\bf Changes to \pal{} ABI.~} When implementing \sysname{},
...
\vspace{5pt}
\noindent{\bf Comparison with Micro-kernels.~}
