...
\\\hline
\end{tabular}
\caption[\sysname{}: application benchmark results.]
...
\end{tabular}
\caption[\sysname{}: \lmbench{} benchmarking results.]
...
\vspace{5pt}
\noindent{\bf Isolation Experiments.~} This subsection tests whether \sysname{} meets its goal of providing equivalent isolation
to a VM.
...
\vspace{5pt}
\noindent {\bf Analysis of Linux Vulnerabilities.~} \sysname{} restricts \picoprocs{} to 15\% of the system call table.
