...
& \multicolumn{2}{c|}{{\bf \sysname{}}} \\\hline
...
(3) a \sysname{} \picoproc{},
(4) a \sysname{} \picoproc{} in a \sgx{} enclave,
 where appropriate. Lower is better.  
Overheads are relative to Linux. \fixme{Update \sysname{} and \graphenesgx{} numbers}} 
...
In these samples, however, \sysname{} also had 3--4\x{} as many processes
...
Across all workloads, \sysname{}'s memory footprint is 3--20\x{}  
smaller than KVM.  
...
\hline
{\bf \gcc/make} & \multicolumn{2}{c|}{\bf Linux} & \multicolumn{3}{c|}{{\bf in KVM}} & \multicolumn{3}{c|}{{\bf \sysname{} + SC + RM}} & \multicolumn{3}{c|}{{\bf \sysname{} + \sgx{}}} \\
\hline
% gcc
...
\hline
{\bf Apache} & \multicolumn{2}{c|}{\bf Linux} & \multicolumn{3}{c|}{{\bf in in KVM}} & \multicolumn{3}{c|}{{\bf \sysname{} + SC + RM}}  & \multicolumn{3}{c|}{{\bf \sysname{} + \sgx{}}} \\
\hline
...
{\bf \light{}} & \multicolumn{2}{c|}{\bf Linux} & \multicolumn{3}{c|}{{\bf in KVM}} & \multicolumn{3}{c|}{{\bf \sysname{} + SC + RM}} & \multicolumn{3}{c|}{{\bf \sysname{} + \sgx{}}} \\
\hline
...
%%%%% UnixBench
  ...
  & \multicolumn{11}{c|}{Execution Time (s), +/- Conf. Interval, \% Overhead} \\
\hline
{\bf bash } & \multicolumn{2}{c|}{\bf Linux} & \multicolumn{3}{c|}{{\bf in KVM}} & \multicolumn{3}{c|}{{\bf \sysname{} + RM}} & \multicolumn{3}{c|}{{\bf \graphenesgx{}}} \\
\hline
%2.1 s linux
%graphene 10.06s
...
{Application benchmark execution times in a (1) native Linux process, (2) a process inside a KVM virtual machine, (3) a \sysname{} \picoproc{} with the SECCOMP filter ({\bf +SC}) and reference monitor ({\bf +RM}), and (3) \sysname{} in \sgx{} enclaves. }
...
}} & \multicolumn{3}{c|}{{\bf \sysname{} + SC + RM}} & \multicolumn{3}{c|}{{\bf \sysname{} + \sgx{}}} \\
&
\usec{} & +/- & 
\usec{} & +/- & \%O &
\usec{} & +/- & \%O & 
...
{\lmbench{} comparison among (1) native Linux processes, (2) \sysname{} \picoprocs{} on Linux host, both without and with the SECCOMP filter ({\bf +SC}) and reference monitor ({\bf +RM}), and (3) \sysname{} in \sgx{} enclaves.
...
Overheads are relative to Linux; negative overheads indicate improved performance. \fixme{Update \sysname{} and \graphenesgx{} numbers}} 
...
Execution time is in microseconds, and lower is better.
overheads are relative to Linux, and negative overheads indicate improved performance. \fixme{Update \sysname{} and \graphenesgx{} numbers}}
