...
\S\ref{sec:background} introduces the \sysname{} design in the context of recent library OS research,
%\S\ref{sec:linux} describes the \sysname{}  design \fixmedp{cut?},
