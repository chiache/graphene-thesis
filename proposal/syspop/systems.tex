...
\midrule
\addlinespace
User-Mode-Linux \kernelversion{} & 284 & {\tt name\_to\_handle\_at}, {\tt iopl}, {\tt ioperm}, {\tt perf\_event\_open} & 93.1\% \\
\addlinespace
\hline
\addlinespace
...
\center{
\small
\begin{tabular}{>{\raggedright\arraybackslash}m{1in}>{\raggedleft\arraybackslash}m{0.4in}>{\raggedright\arraybackslash\footnotesize}m{2.4in}>{\raggedleft\arraybackslash}m{1in}>{\raggedleft\arraybackslash}m{1in}}
\toprule
