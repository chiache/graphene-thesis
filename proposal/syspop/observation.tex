...
\vspace{-0.1in}
\center{
\includegraphics[width=3.6in]{syspop/figures/ioctl-popularity-by-inst.pdf}
}
...
\vspace{-0.3in}
\center{
\includegraphics[width=2.3in]{syspop/figures/fcntl-popularity-by-inst.pdf}
\hspace{0.5in}
\includegraphics[width=2.3in]{syspop/figures/prctl-popularity-by-inst.pdf}
}
...
\center{
\small
\begin{tabular}{>{\footnotesize\raggedright\arraybackslash}m{4.5in}>{\raggedright\arraybackslash}m{1.6in}}
\hline
\addlinespace
