...
{Ranking of \usagemetric{} among 188 {ioctl} operations with highest \usagemetric{}, {\tt fcntl} and {\tt prctl} opcodes.  Higher is more important; 100\% indicates all installations include software that request the operations.}
...
\begin{figure}[t]
\centering
\includegraphics[width=6in]{syspop/figures/dev-proc-popularity-by-inst.pdf}
