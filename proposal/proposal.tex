...
\newcommand{\thesistitle}{Partitioning Security and Performance Pitfalls with Optimal Legacy Code Reuse}
...
\declarecommand{\gsgx}{Graphene-SGX}
...
\declarecommand{\liboses}{libOSes}
...
{\setstretch{1.5}\centering{\Large\bf{\thesistitle{}}}\\}
