...
The interaction between the trusted and untrusted parts is through \term{untrusted interfaces}.
...
\term{Haven}~\citep{baumann14haven}
shows a \term{non-partitioned usage model},
