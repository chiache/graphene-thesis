...
For example, {\tt open} may return a file descriptor that points
...
In addition, \sysname{} does not include {\tt fsync} in the untrusted interface,
...
\paragraph{The Integrity of Applications.}
...
\sysname{} guarantees the integrity of applications through a different way.
