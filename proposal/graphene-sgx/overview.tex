\section{Isolating Legacy Applications in \intel{} \sgx{} Enclaves}
...
\caption[The \sysname{} untrusted interface]
{The \sysname{} untrusted interface, which consists of \interfacenum{} functions in total.
