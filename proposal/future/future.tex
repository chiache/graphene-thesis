...
\graphene{} ported to a \microkernel{} or hypervisor will minimize both the attack surface and the shared TCB.
The functionality of \graphene{} ported to L4 will be similar as
