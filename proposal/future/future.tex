...
\fixme{rewriting the future works}
...
Existing \liboses{} enable legacy applications
...
To provide \term{platform independent},
\liboses{} rely on the definition of host ABI to be
generic to underlying platforms~\citep{porter11drawbridge, baumann13bascule, baumann14haven, tsai14graphene}
--- assuming porting the host ABI to different platforms
shall be reasonably feasible.
