...
a portion of existing development effort,
...
The design of \picoprocs{} disallows any management of credentials or access control inside \liboses{},
...
--- being allowed to access any OS resources and abstractions
in its sandbox.
