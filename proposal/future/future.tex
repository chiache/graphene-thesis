...
In our ongoing work,
we explore a system design that automatically partitions a legacy \java{} application,
...
For future works,
the framework can be extended to secure more use cases and corner cases.
