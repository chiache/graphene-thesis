...
but also extend the host environment for \graphene{} to heterogeneous architecture.
The implementation of \graphene{} host ABI on Barrelfish
can rely on its tool chain for the partially supported POSIX APIs,
...
such as x86, x86\_64 and ARM.


In general, we observe that many platforms provide \term{POSIX-compliant APIs},
