...
On the other hand, developers pay assorted efforts to port applications
...
Especially, the platform independence of \graphene{}
can extend
...
can seal the secrets in applications,
in an environment immune to attacks from host kernels and hardware peripherals.
