...
will split the partial functionality of a kernel into
...
A \picoproc{} will bound the execution of \libos{}
in the virtual address apace,
and narrow the attack surface between a \picoproc{} and its host kernel,
...
A \libos{} can
dismissed or compiled out
the unneeded or redundant OS logics
from the critical paths of specific applications.
