...
%of legacy support~\citep{tsai16apistudy}.
Alternatively,
...
in innovative system designs. % (e.g., \liboses{}).
Besides supporting applications as a whole,
we explore opportunity for porting legacy applications
...
when being partitioned into enclaves
...
to isolate particularly sensitive execution from untrusted hosts and components.
...
and implementing major OS personality, such as resource scheduling APIs,
hardware feature support, and security models.
