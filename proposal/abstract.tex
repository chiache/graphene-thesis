...
and a system with fully compatible legacy support will require no porting efforts.
Essentially,
...
which supports various Linux, multi-process abstractions.
%For instance,
