...
A key challenge for a partitioned or optimized system is
how to reuse legacy code, %from prior systems and applications,
...
which enforce security isolation, platform independence, migrations, or other features.
