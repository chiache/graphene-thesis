...
is to ensure
the security benefits promised by the \intel{} \sgx{} platform,
...
instead of relying on remote servers.
The off-line launching model of \graphenesgx{}
ensures that process creation policies in enclaves can be individually configured
--- a parent enclave can identify
the application binaries loaded in its children.
