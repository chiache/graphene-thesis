...
process creation policies in enclaves can be individually configured
...
other first-order requirements in systems include
achieving
optimal performance
--- as pursuing either low latency or high throughput,
according how users define quality of service.
