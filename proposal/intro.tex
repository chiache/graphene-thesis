...
The root cause of the complexity in porting legacy applications
...
For instance, \term{\liboses{}} enforce isolation on mutually distrusting process,
...
--- comparable to the benefits brought by \term{virtualization},
...
The reason for pursuing \java{} applications partitioning
is two-folded.
...
\item
A study of Linux API usage and compatibility~\citep{tsai16apistudy}, to collect the information which is missing in
the decision-making process of system developers.
The study provides
an approach to measuring platform compatibility, suitable for evaluating the relative completeness of prototype systems.
...
that combines the benefits of isolated execution of \intel{} \sgx{} and
