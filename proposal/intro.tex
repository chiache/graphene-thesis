...
--- to explicitly run {\tt pal} or {\tt pal-sgx} to load applications in \graphene{} or \gsgx{}. 
...
can demand a regular process to be migrated into an enclave
...
if tainted by a low-security applications already isolated in a \picoproc{}.
