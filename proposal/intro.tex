...
a large fraction of the existing applications
...
port legacy applications from one platform, OS or language runtime to another,
...
Some of the APIs are vastly different and difficult to translate
...
For instance, \term{\liboses{}} enforce isolation on mutually untrusting process,
...
onto new hardware platforms, such as \term{\intel{} \sgx{} enclaves}~\citep{baumann14haven}.
...
for which emulation can be completely wrapped inside each \picoprocs{}. %, with proper level of translation and bookkeeping.
...
oppose the system assumptions. % of operating systems. 
...
and performance.
For instance, in \graphene{}, coordinating OS states %for multi-process abstractions
over PRC streams
