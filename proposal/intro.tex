...
Such a characteristic of the solutions make it feasible to migrate an application or a \picoproc{} dynamically among Linux, \graphene{} and \gsgx{}.
...
--- a signed, security-sensitive application will seamlessly run in an enclave,
...
Similar technique can be applied to drop the privilege of a regular application to a \picoproc{} if tainted.
...
Fo instance, \gsgx{}, the size of \libos{} and supporting libraries
...
All these code and data are not always necessary, and can be shredded more carefully.
