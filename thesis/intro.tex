...
The challenge of reusing applications shows that 
a universal solution is needed to shorten the cycle for a new OS or hardware platform to be applied on real-world applications. The solution requires minimizing the per-platform effort for implementing the OS functionality and addressing any platform-specific security or performance concerns (e.g., Iago attacks to Intel SGX). 
