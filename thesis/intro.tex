...
It often takes significant efforts or techniques,
such as Windows using lightweight virtual machines to run outdated applications,
for system developers to keep different OS generations or distributions compatible to same applications.
For OS prototypes created to overcome issues of major OSes,
existing Windows or UNIX applications often don't work right out-of-the-box on these OS prototypes, due to fundamentally changing the OS architecture or personality.
