...
\ifx \prethesis \undefined
\newenvironment{outline}{\begin{comment}}{\end{comment}}
\else
...
\newcommand{\thesistitle}{Simplifying Application Reuse and Isolation on Emerging Systems Using the Graphene Library OSes}
