\section{Background of File System Directory Cache}
...
Much of the dcache optimization effort illustrated in Figure~\ref{fig:dcache:by-version}
...
\begin{figure}
\centering
\includegraphics[width=5in]{dcache/plots/lookup-breakdown.pdf} \\
\footnotesize
\begin{tabular}{lll}
{\bf Path1:} \tt FFF &
{\bf Path2:} \tt XXX/FFF &
