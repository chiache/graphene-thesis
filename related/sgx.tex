\section{OS Support for Security Hardware}
...
XOM realizes a similar trust model as \sgx{}, except a few details, such as lack of paging support, and supporting \syscall{fork} by sharing the encryption key across containers.
...
Sanctum~\cite{costan2016sanctum} is a RISC-V processor prototype that targets a minimal and open design for the enclave feature.
