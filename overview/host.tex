...
the \syscall{read} and \syscall{write} system calls on Linux,
or the \syscall{ReadFile} and \syscall{WriteFile} APIs on Windows.
...
For sufficiency, the definition of the host ABIs
