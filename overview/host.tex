...
The host ABI 
determines a boundary, which partitions OS components %, such as system calls and namespaces,
into a library OS,
...
to isolate the potential OS customization on specific hardware. %any potential changes for adopting new hardware.
