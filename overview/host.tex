...
to common OS functions. For example, the \syscall{FileRead} and \syscall{FileWrite} functions in the host ABI are similar to \syscall{pread} and \syscall{pwrite} in POSIX, except some nuanced details like order of parameters.
