...
\graphene{} starts with defining a simple host ABI (application binary interface)
...
\subsection{Platform Adaption Layers (PALs)}
...
\subsection{An overview of \hostapis{}}
