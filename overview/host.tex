...
We can find lookalike functions in many OSes, such as \syscall{read} and \syscall{write} in Linux, BSD, and POSIX, and \syscall{ReadFile} and \syscall{WriteFile} in Windows (for regular files).
