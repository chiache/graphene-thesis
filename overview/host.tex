...
we argue that the natures of the OS functions in Linux and Windows have no much differences. 
During the development of \graphene{}, we do found several occasions in which we have to introduce new functions into the host ABI to deal with Linux-specific challenges, which will be further discussed in Section~\ref{sec:overview:host:functions} and Chapter~\ref{chap:abi}.
