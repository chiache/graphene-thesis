...
\graphene{} moves the OS components which implements the Linux system interface,
into an in-process, para-virtualized library OS,
leaving only the host ABI to request hardware resources
from the host OSes.
