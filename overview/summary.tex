...
The whole \graphene{} design is centered around building an extra para-virtualization layer, instead of implementing a significantly larger set
...
The rest of effort goes into decoupling the porting issue on the hosts from the compatibility issue in the library OS.
Chapter~\ref{chap:abi} and chapter~\ref{chap:sgx} will discuss the definition and implementation of the host ABIs in depth.
Chapter~\ref{chap:libos} will describe the details of developing the library OS with compatibility to Linux applications.
