...
and implements a sufficient amount of Linux system calls (implemented \graphenesyscalls{} system calls, either wholly or partially), to run unmodified Linux applications.
\graphene{} decouples the development for a compatibility layer,
from host-specific challenges to implementing OS features, and isolating applications from other malicious tenants.
