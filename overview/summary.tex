...
building a para-virtualized layer (i.e., platform adaption layer) to reuse typical OS components, such as the system call table and namspaces in a \libos{}. %, for reproducing the OS features which are prerequisite to applications.
