...
application instance, and can potentially be more efficiently
...
Similar challenges are observed %have been observed for implementing \thehostabi{}
on other alternative kernels such as FreeBSD, OSX, and Windows.
