...
The elapsed time between a existing \thelibos{} instance calling \palcall{ProcessCreate} and a new \thelibos{} instance starting to run
contributes to a major part of the \syscall{fork} latency overhead
in \graphene{}.
