...
\graphene{} reduces the attack surface of the host Linux kernel, but keeps the trusted computing base (TCB) unchanged; however, reducing the effective \linuxapi{} table size of a \picoproc{} does facilitate adoption of a smaller host kernel.
