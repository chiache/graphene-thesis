...
Using an existing mechanism like \seccomp{},
...
on a system, \graphene{} allows OS developers to focus
on testing or inspecting a small amount of the corner cases and execution paths
in a Linux kernel.
...
checks the arguments of a host \linuxapi{} for referencing a sharable resource.
A host \linuxapi{} like \syscall{open}, \syscall{connect}, or \syscall{bind}
specifies a file path or a network address
for opening a file or network stream as an abstraction of \thehostabi{}.
