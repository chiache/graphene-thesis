...
such as only permitting specific opcodes for \syscall{ioctl} or specific process creation flags for \syscall{clone}.
...
with straightforward rules written in BPF macros.  %Experiments show that adding more precise argument checks has no significant impact on \linuxapi{} latency.
