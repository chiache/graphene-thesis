...
The evaluation in this section is based on running micro-benchmark programs, similar to \lmbench{} 2.5~\cite{McVoy:lmbench}, on both the Linux and SGX PAL,
...
The \seccomp{} filter adds 7-10\% overheads, or \roughly{}0.9 \usec{}, to the latency of \palcall{StreamOpen}. Finally, if the reference monitor is enabled, the reference monitor adds an extra 14-21\% overheads, and the overheads are roughly correlated with the length of requested paths.
