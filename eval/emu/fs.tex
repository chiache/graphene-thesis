...
Sources of file system overheads in \thelibos{}
can be categorized as two.
One type of overheads is the costs in the local file system directory cache of \thelibos{},
which stores directory hierarchies and attributes
in \picoproc{} memory to avoid duplicated \hostapis{}.
