This chapter evaluates the performance and security of  \graphene{} on Linux and SGX hosts.
...
Each KVM or Xen Guest is deployed with 4 virtual CPU with VT and EPT (Extended Page Table), 8GB RAM, a 30GB virtual disk image, VirtIO enabled for network and disk, bridged connection with TAP, and runs the same Ubuntu and Linux kernel image as the host OS.
