...
The host OS for evaluating the Linux and SGX ports of \graphene{} is Ubuntu \ubuntuversion, with Linux kernel \linuxversion{}.
...
For \graphenesgx{},
the version of
the Intel \sgx{} Linux SDK~\cite{intel-sgx-linux-sdk} and driver~\cite{intel-sgx-linux-driver} is \sgxdriverversion{}.