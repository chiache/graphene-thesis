...
on a Linux kernel and inside of a SGX enclave.
The evaluation
...
As two other baselines for comparing the application performance and resource usage,
The host OS also
includes KVM on QEMU version 2.5, and Xen 4.6.5.
