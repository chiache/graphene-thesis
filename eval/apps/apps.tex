...
%The experiment observes that both \graphene{} and \graphenesgx{} tend to perform poorly in an event-driven server.
...
The experiments measure the latency or execution time of these applications. 
...
OS they don't trust.
The experiment used an R benchmark suite developed by Urbanek et al.~\cite{r-benchmark-25}, which includes 15 CPU-bound workloads such as matrix computation and number processing.
...
The experiment tests the compilation of thee source files with varied sizes,
