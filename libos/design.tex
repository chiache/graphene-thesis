...
with assembly code that directly invokes \linuxapis{}---usually in a language runtime (e.g., the go language runtime) or a system software (e.g., \projname{busybox}).
