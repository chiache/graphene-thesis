...
\thelibos{} mimics a Linux kernel. A Linux kernel assigns an interrupt handler for \linuxapis{} triggered by an application, using ``\assembly{syscall}'' or ``\assembly{int \$80}'' instructions.
