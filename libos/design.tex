...
\paragraph{Hard-coded \code{syscall} instructions.}
A static binary, or sometimes a platform-dependent application, may contain hard-coded \code{syscall} instructions
...
with embedded \code{syscall} instructions.
