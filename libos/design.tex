...
\paragraph{Statically-compiled \linuxapis{}.}
Statically-linked binaries, and a few applications, contain hard-coded \code{syscall} instructions,
...
to spot and modify all the hard-code \code{syscall} instructions.
