...
\thelibos{} also applies several optimizations of Tsai et al., 2015~\cite{tsai15dcache}, to improve the latency and frequency of cache hits
...
a negative directory entry can be created inside the directory cache, to prevent future \linuxapis{} from calling \palcall{StreamAttrQuery} to query the existence of the path.
