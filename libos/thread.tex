...
\libpthread{} implements all these synchronization primitives based on futexes (accessed by Linux's \syscall{futex} \linuxapi{}). %one single \syscall{futex} \linuxapi{}.
