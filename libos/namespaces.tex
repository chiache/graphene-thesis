...
System V IPC including message queues and semaphores, shared file system and file descriptor states (Table~\ref{tab:libos:multiproc}).
...
\footnotesize
\centering
\begin{tabular}{|p{.16\textwidth}|p{.25\textwidth}|p{.5\textwidth}|}
\hline
...
FIFO \& domain sockets \newline
Symbolic links \newline
File system locks & No coordination, create special files in the host to represent symbolic links and file locks. \\
\hline
\raggedright
